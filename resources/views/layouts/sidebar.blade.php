<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="active"><a href="{{ route('categories.index') }}"><i class="fa fa-list"></i> <span>Kategori Bahan Baku</span></a></li>
            <li class="active"><a href="{{ route('products.index') }}"><i class="fa fa-cubes"></i> <span>Bahan Baku</span></a></li>
            ...
            <li class="active"><a href="{{ route('productsOut.index') }}"><i class="fa fa-minus"></i> <span>Bahan Keluar</span></a></li>

            <li class="active"><a href="{{ route('productsIn.index') }}"><i class="fa fa-plus"></i> <span>Bahan Masuk</span></a></li>
